...
public class StarbucksServer extends Application {
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach( "/starbucks/order/{order_id}", OrderResource.class ) ;        
        router.attach( "/starbucks/order/{order_id}/pay", PaymentResource.class ) ;        
        router.attach( "/starbucks/order", OrderResource.class ) ;        
        router.attach( "/starbucks/orders", OrdersResource.class ) ;        
